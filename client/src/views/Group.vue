  ...
  <main>
    ...
    <div class="task-resource-container">
      <section class="left">
        <h1>Tasks</h1>
        <div class="task-list">
          <Task v-for="task in tasks" :task-id="task._id" :key="task._id" taskAssignee="jim"
            :task-name="task.TaskName" :belongs-to-group="group" :task-description="task.Description" :task-status="task.Status" :task-label="task.Priority"
